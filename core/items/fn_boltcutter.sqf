...
//if((nearestObject [[13217.462,13489.88,19.159515],"Land_Dome_Big_F"]) == _building OR (nearestObject [[13217.462,13489.88,19.159515],"Land_Research_house_V1_F"]) == _building) then {
